...
/**
 * @brief Módulo para ver si un numero cumple una condicion (en este caso si es Primo)
 * @param int numero
 * @return bool Primo (true es Primo) (false no es Primo)
 * @version 1
 * @author Dios-Fer
 * @date 2023-09-04
 */
...
/**
 * @brief Módulo para ver si un vector del cual se quieren copiar ciertas celdas cabe o no en otro vector (en funcion de una condicion (en este caso que sea Primo))
...
/**
 * @brief Módulo para copiar ciertas celdas de un vector en la dimension de otro siempre que cuente con el espacio suficiente (y cumpliendo una condicion (en este caso si es Primo))
