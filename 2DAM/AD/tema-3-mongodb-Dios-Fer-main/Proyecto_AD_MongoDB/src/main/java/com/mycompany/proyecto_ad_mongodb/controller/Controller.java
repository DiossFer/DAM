...
import com.mycompany.proyecto_ad_mongodb.conexion.Conexion;
...
public class Controller {
     ...
     */
    public Controller (String dbName)  throws MongoException {
    ...
    public void cerrar_conexion ()  throws MongoException{
        conn.cerrarConexion();
    }
     ...
     * @param String region
     */
    public void crearServidor (String region) throws MongoException{
     ...
     */
    public void ModificarServidor (String Id, String region) throws MongoException{
        int i=0;
     ...
     */
    public String EliminarServidor (String Id) throws MongoException{
     ...
     */
    public String crearInventario (int slotsMaximos, int slotsOcupados, String[] idsJugadorInventarios) throws MongoException{
     ...
     * @param String[] idsJugadorInventarios -> jugadores con acceso a ese inventario
     */
    public String ModificarInventario (String Id, int slotsMaximos, int slotsOcupados, String[] idsJugadorInventarios) throws MongoException{
     ...
     */
    public String EliminarInventario (String Id) throws MongoException{
        String mensaje = "VALIDO";
        int i=0;
     ...
     */
    public String crearPartida (int numEspectadores, String IdServerPartida, String[] idsjugadores) throws MongoException{
     ...
     * @param String[] idsjugadores -> grupo de ids de jugadores que seran usadas para buscar el jugador y asignarlo a la partida
     */
    public String ModificarPartida (String Id, int numEspectadores, String id_server, String[] idsjugadores) throws MongoException{
        String mensaje = "VALIDO";
     ...
     */
    public void EliminarPartida (String Id) throws MongoException{
        int i=0;
     ...
     */
    public String crearJugador (String NickName, int nivel, String[] idsInventariosJugador) throws MongoException{
     ...
     * @param String[] idsInventariosJugador -> grupo de ids de inventarios usados para asignar a estos al jugador      
     */
    public String ModificarJugador (String Id, String NickName, int nivel, String [] idsInventariosJugador) throws MongoException{
     ...
     */
    public String EliminarJugador (String Id) throws MongoException{
        String mensaje = "VALIDO";
        int i=0;
        for (i=0; i<jugadores_sistema.size() && !jugadores_sistema.get(i).getIdPlayer().equals(Id); i++){
        }
