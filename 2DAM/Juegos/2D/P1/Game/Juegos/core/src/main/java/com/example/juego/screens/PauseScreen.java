...
public class PauseScreen implements Screen {
    ...
    public PauseScreen (MyGdxGame g, MainScreen m){
    ...
    private void createUI() {
        ...
        TextButton resumeButton = new TextButton("Continue", textButtonStyle);
        resumeButton.getLabel().setColor(Color.BROWN);
        
        resumeButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(pauseGame);
                dispose();  
            }
        });
        table.row();
        table.add(resumeButton).padBottom(15);


        TextButton menuPrincipal = new TextButton("Main menu", textButtonStyle);
        menuPrincipal.getLabel().setColor(Color.BROWN);
        ...
        table.row();
        table.add(menuPrincipal).padBottom(15);
        ...
        exit.getLabel().setColor(Color.BROWN);
