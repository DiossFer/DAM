 ...
 * @author DiosFer
 */
public class Personaje3 extends Entidad {
    ...
    public Personaje3() {
        ...
        Texture koalaTexture = Textures.koalaTexture;
    ...
    @Override
    public void act(float delta) {  // Personaje 2 --> Volador puede volar haciendo saltos indefinidos
        time = time + delta;
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.UP) || (Gdx.input.justTouched() && Gdx.input.getY() < Gdx.graphics.getHeight() / 2)) {
