 ...
 * @author DiosFer
 */
public class Personaje2 extends Entidad {  // Personaje 2 --> Fantasma es rapido y no tiene contacto con enemigos
    ...
    public Personaje2() {
        ...
        Texture koalaTexture = Textures.marioTexture;
        ...
        hitBox = new Rectangle(this.getX(), this.getY(), 0, 0);
