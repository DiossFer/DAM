...
import com.example.juego.Renderer;
import com.example.juego.simulation.Simulation;
import com.example.juego.simulation.SimulationListener;
...
public class GameLoop extends InvadersScreen implements SimulationListener {
	...
	public void update (float delta) {
		...
		if (Gdx.input.isKeyJustPressed(Keys.SPACE)) simulation.shot();
	}
