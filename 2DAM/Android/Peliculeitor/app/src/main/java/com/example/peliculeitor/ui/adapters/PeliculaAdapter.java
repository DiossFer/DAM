...
public class PeliculaAdapter extends RecyclerView.Adapter<PeliculaAdapter.PeliculaViewHolder> {
    ...
    public static class PeliculaViewHolder
        ...
        public void bindPelicula(Result s, final OnItemClickListener listener) {
    ...
    public PeliculaAdapter(List<Result> datos, OnItemClickListener listener) {
        this.datos = datos;
    ...
    public void onBindViewHolder(PeliculaViewHolder viewHolder, int pos) {
        ...
        viewHolder.bindPelicula(s,listener);
    }
