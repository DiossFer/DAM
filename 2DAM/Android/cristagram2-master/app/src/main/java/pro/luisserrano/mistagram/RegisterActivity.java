...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OK //TODO(8): inicializar auth a la instancia de FirebaseAuth

        auth = FirebaseAuth.getInstance();

        // OK //TODO(9): colocar un listener a txtLogin de modo que lance LoginActivity si hace click
        binding.txtLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentRegister = new Intent(getBaseContext(), LoginActivity.class);
        ...
        binding.register.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // OK //TODO(10): Hacer los correspondientes if-else para que se puedan mostrar los siguientes toasts correctamente
                if (binding.password.getText().length()==0 || binding.username.getText().length()==0 || binding.fullname.getText().length()==0 || binding.email.getText().length()==0){
